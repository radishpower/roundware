...
- (void)viewDidLoad {
	...
	NSURL *url = [NSURL URLWithString:@"http://halseyburgund.com/work/scapes/"];
	SHKItem *item = [SHKItem URL:url title:@"Check out Scapes for iPhone and Android by Halsey Burgund!"];
