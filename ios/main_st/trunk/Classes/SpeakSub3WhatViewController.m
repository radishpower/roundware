...
- (void)viewDidLoad {
    ...
    // Calling this will force the speak questions to be released and reloaded from the server
    [(ScapesAppDelegate *)[[UIApplication sharedApplication] delegate] freeSpeakQuestions]; 
