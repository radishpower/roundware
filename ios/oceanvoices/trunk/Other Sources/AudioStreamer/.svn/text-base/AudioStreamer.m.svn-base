	...
	@synchronized(self)
	{
		...
		UIAlertView *alert =
			[[[UIAlertView alloc]
			    ...
			    message:[NSString stringWithFormat:@"%@\n\n%@", NSLocalizedStringFromTable([AudioStreamer stringForErrorCode:self.errorCode], @"Errors", nil), @"If this error persists, please try quitting the app and relaunching it."]
				delegate:self
