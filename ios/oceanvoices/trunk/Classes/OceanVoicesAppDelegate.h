...
@interface OceanVoicesAppDelegate : NSObject <UIApplicationDelegate, CLLocationManagerDelegate, AVAudioSessionDelegate> {
...
@property (nonatomic, retain) NSDictionary *usertypeChoices;
