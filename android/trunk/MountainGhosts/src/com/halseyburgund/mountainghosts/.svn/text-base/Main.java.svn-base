 ...
 */
package com.halseyburgund.mountainghosts;

import java.util.UUID;

import com.halseyburgund.mountainghosts.activity.Listen;
import com.halseyburgund.mountainghosts.activity.Preferences;
import com.halseyburgund.mountainghosts.activity.Speak;
import com.halseyburgund.mountainghosts.view.VersionDialog;
...
public class Main extends Activity {
	...
	// debugging
	private final static String TAG = "MtnGhosts";
	private final static boolean D = false;

    public final static String STORAGE_PATH = Environment.getExternalStorageDirectory().getAbsolutePath() + "/mtnghosts/";
    
    public final static String PREFS = "MtnGhosts";
	...
	private void showVersionDialog(boolean forced) {
		try {
			VersionDialog.show(this, "com.halseyburgund.mountainghosts", R.layout.version_dialog, R.string.version_text, forced);
		} catch (Exception e) {
